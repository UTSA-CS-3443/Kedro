 ...
 * initializes all the hyperlinks and sets current event object to the one selected
 * @author SpaceHawks
 *
 */
public class EventSearchController implements Initializable, EventHandler<ActionEvent> {
	...
	/**
	 * initializes all the hyperlinks based on number events with a max of 10
	 * if no events are found displays an alert and allows user to travel back to event page
	...
	/**
	 * makes main event object the event object at array 0 and changes scene to event view page
	...
	/**
	 * makes main event object the event object at array 1 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 2 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 3 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 4 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 5 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 6 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 7 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 8 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
	...
	/**
	 * makes main event object the event object at array 9 and changes scene to event view page
	 * @param arg0 - enables use through fxml
	 */
